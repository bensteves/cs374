 ...
 *
 * Computes the vector square root of A into C 
...
int main(int argc, char** argv)
{
    double startTime = 0.0, totalTime = 0.0,
    	   ...
    	   rootTime = 0.0, totalRootTime = 0.0,
    ...
    printf("[Vector square root of %lu elements]\n", numElements);
   ...
   // printf("CUDA kernel launch with %d blocks of %d threads\n", blocksPerGrid, threadsPerBlock);
    ...
    totalRootTime = omp_get_wtime() - rootTime;
...
//    printf("Normal time: %lf\n", stopTime-startTime); 
   ...
   // free(h_B);
    ...
    printf("AB Copy: %f \nSquare root: %f \nC copy: %f \n", totalABcopyTime, totalRootTime, totalCcopyTime);
