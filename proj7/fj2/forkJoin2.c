...
int main(int argc, char** argv) {
    ...
    #pragma omp parallel //will print Part I max allowable times on first run through
    printf("\nPart I");

    printf("\n\nBetween I and II...\n"); //not printed in parallel

    omp_set_num_threads(3);

    #pragma omp parallel  //now will print 3 times
    printf("\nPart II...");
    ...
    #pragma omp parallel //prints 3 times because we set num threads to 3. 
    printf("\nPart IV...");
