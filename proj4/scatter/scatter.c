...
//max is user defined constant - in this case 8. if 4 procs, 8/4 = 2, so each proc gets 2 vals
// different arrays technically from processes. aRcv is the receive data so takes the arrays
